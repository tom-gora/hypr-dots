...
local M, opts, dependencies, notify_override, no_spinner

notify_override = function(direction)
...
dependencies = {
	"MunifTanjim/nui.nvim",
	{
		...
		config = vim.schedule(function()
			...
			util.get_slot_range = notify_override
		end),
		opts = {
...
M = {
	...
	config = vim.schedule(no_spinner),
}
