...
--
local c = require("tomeczku.core.custom_theme.palette")
...
theme.set_highlights = function()
	...
	hl(0, "FloatBorder", { fg = c.moon_teal, bg = "NONE" })
	hl(0, "VertSplit", { fg = c.line, bg = "NONE" })
	hl(0, "CursorLine", { fg = "NONE", bg = c.lighter_black })
	...
	hl(0, "Label", { fg = c.moon_pink, bg = "NONE" })
	...
	hl(0, "TelescopeSelection", { fg = c.white, bg = c.lighter_black })
	...
	hl(0, "StatusLineNC", { fg = "NONE", bg = c.black })
