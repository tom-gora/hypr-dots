...
THEME.setup = function(theme_name)
	...
	hl(0, "Comment", { fg = p.black.muted_dark, bg = "NONE", italic = true })
	...
	hl(0, "FloatBorder", { fg = p.cyan.base, bg = p.black.dark })
	hl(0, "VertSplit", { fg = p.black.muted_dark, bg = "NONE" })
	hl(0, "CursorLine", { fg = "NONE", bg = p.black.lighter })
	hl(0, "CursorColumn", { fg = "NONE", bg = p.black.dark })
	hl(0, "ColorColumn", { fg = "NONE", bg = p.black.dark })
	hl(0, "NormalFloat", { fg = "NONE", bg = p.black.dark })
	...
	hl(0, "Cursor", { fg = p.black.base, bg = p.white.base })
	...
	hl(0, "@punctuation.delimiter", { fg = p.black.muted_base, bg = "NONE" })
	...
	--
	-- mini indentscope
	hl(0, "MiniIndentscopeSymbol", { fg = p.purple.muted, bg = p.black.base, sp = "NONE" })
	--
	-- fzflua
	hl(0, "FzfLuaNormal", { fg = p.white.base, bg = p.black.dark, force = true })
	hl(0, "FzfLuaBorder", { fg = p.black.lighter, bg = p.black.dark, force = true })
	hl(0, "FzfLuaTitle", { fg = p.purple.base, bg = p.black.dark, force = true })
	hl(0, "FzfLuaBackdrop", { bg = p.black.dark, force = true })
	hl(0, "FzfLuaPreviewBorder", { link = "FzfLuaBorder", force = true })
	hl(0, "FzfLuaPreviewNormal", { bg = p.black.dark, force = true })
	hl(0, "FzfLuaCursorLine", { bg = p.purple.base, force = true })
	hl(0, "FzfLuaLivePrompt", { fg = p.purple.delimiter, bg = "none" })
	hl(0, "FzfLuaFzfCursorLine", { bg = p.white.darker, fg = p.black.darker, force = true })
