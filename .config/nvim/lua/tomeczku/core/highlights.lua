...
vim.api.nvim_create_autocmd({ "VimEnter", "ColorScheme" }, {
	...
	callback = function()
		...
		modify_hl_group("InvisibleTxt", { fg = base_bg, bg = "NONE" })
		modify_hl_group("InvisibleBg", { bg = "NONE" })
		modify_hl_group("MyLineNrAbove", { fg = line_nr_red, bg = "NONE", force = true })
		modify_hl_group("MyLineNrBelow", { fg = line_nr_teal, bg = "NONE", force = true })
		modify_hl_group("LineNrAbove", { link = "MyLineNrAbove", force = true })
